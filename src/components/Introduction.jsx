          ...
          <div className="flex gap-7 items-center w-full">
            ...
            >
              <button
                ...
                class="inline-flex items-center whitespace-nowrap min-w-fit rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input bg-background shadow-sm hover:bg-gray-700 hover:text-accent-foreground h-9 px-4 py-2 gap-1"
              >
            ...
            <motion.a
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              href="https://www.linkedin.com/in/suraj-raj-9401b7200/"
              target="_"
            >
            ...
            <motion.a
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              href="https://github.com/suraj-fusion"
              target="_"
            >
            ...
            <motion.a
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              href="https://x.com/Suraj46476457/"
              target="_"
            >
            ...
            <motion.a
              ...
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              href="https://takeuforward.org/plus/profile/suraj-fusion"
              target="_"
            >
