        ...
        <section className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <div className="p-6 pt-0 flex h-full flex-col items-start justify-between gap-4">
              <div className="mt-2 flex flex-wrap gap-1">
                {["React Native", "React Navigation", "Javascript"].map(
                  (tech) => (
                    <div
                      key={tech}
              ...
              <div className="flex flex-row flex-wrap items-start gap-1">
                <a
                  ...
                  href="https://github.com/suraj-fusion/Dialysis-Book"
                >
          ...
          >
            ...
            <div className="p-6 pt-0 flex flex-col gap-2">
              ...
              <div className="prose max-w-full text-pretty font-sans text-xs text-muted-foreground dark:prose-invert">
                <p>
                  Developed a web extension that helps YouTube learners
                  reinforce their understanding by generating multiple-choice
                  questions (MCQs) from video content for self-assessment
                </p>
              </div>
            </div>
            <div className="p-6 pt-0 flex h-full flex-col items-start justify-between gap-4">
          ...
          >
            ...
            <div className="p-6 pt-0 flex flex-col gap-2">
              ...
              <div className="prose max-w-full text-pretty font-sans text-xs text-muted-foreground dark:prose-invert">
                <p>
                  Built a dynamic and interactive frontend web application that
                  enables users to seamlessly search for movies, view detailed
                  information, rate them based on their preferences, and curate
                  a 'watched' list
                </p>
              </div>
            </div>
            <div className="p-6 pt-0 flex h-full flex-col items-start justify-between gap-4">
              <div className="mt-2 flex flex-wrap gap-1">
                {["ReactJS", "Javascript", "CSS"].map((tech) => (
                  <div
                    key={tech}
                    className="inline-flex items-center rounded-md border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 px-1 py-0 text-[10px]"
                  >
          ...
          >
            ...
            <div className="p-6 pt-0 flex flex-col gap-2">
              ...
              <div className="prose max-w-full text-pretty font-sans text-xs text-muted-foreground dark:prose-invert">
                <p>
                  Developed A web app to publish my blogs.All data gets stored
                  on MongoDB Atlas
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="p-6 pt-0 flex flex-col gap-2">
              ...
              <div className="prose max-w-full text-pretty font-sans text-xs text-muted-foreground dark:prose-invert">
                <p>
                  An E blood Bank web appp where interested donors can register
                  to donate blood Users can search with respect to city and
                  blood type they require
                </p>
              </div>
            </div>
            <div className="p-6 pt-0 flex h-full flex-col items-start justify-between gap-4">
              <div className="mt-2 flex flex-wrap gap-1">
                {["HTML", "CSS", "python", "Flask"].map((tech) => (
                  <div
                    key={tech}
                    className="inline-flex items-center rounded-md border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 px-1 py-0 text-[10px]"
                  >
